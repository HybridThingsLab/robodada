class MainView {
    ...
    loadJSON() {
        ...
        input.onchange = (e) => {
            ...
            reader.onload = function (e) {
                ...
                dispatchEvent(
                    new CustomEvent("notifyLoadedJSONFile", {
                        detail: jsonContent,
                    })
                );
            };
    ...
    updateEmojiPosition(trackingResult) {
        ...
        ctx.setTransform(
            ...
            0,
            scale,
            resizedResult.detection.box.x + resizedResult.detection.box.width / 2,
            resizedResult.detection.box.y + resizedResult.detection.box.height / 2
        );
    ...
    switchToPlaybackView() {
        ...
        document.getElementsByClassName("main-screen")[0].classList.add("has-active-cam");
        cam_button.firstElementChild.innerHTML = "deactivate&nbsp;cam";
    ...
    switchToPlanningView() {
        ...
        let cam_button = document.querySelector(".camera-button");
        document.getElementsByClassName("main-screen")[0].classList.remove("has-active-cam");
        cam_button.firstElementChild.innerHTML = "activate&nbsp;cam";
